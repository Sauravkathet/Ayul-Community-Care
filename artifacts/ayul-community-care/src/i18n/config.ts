...
const resources = {
  en: {
    translation: {
      ...
      hero: {
        ...
        subtitle: 'Dedicated NDIS support services in Sydney, helping you achieve your goals and live independently with dignity and respect.',
  ...
  hi: {
    translation: {
      ...
      hero: { title: 'करुणामय देखभाल के माध्यम से जीवन को सशक्त बनाना', subtitle: 'सिडनी में समर्पित NDIS सहायता सेवाएं...', getStarted: 'शुरू करें', contactUs: 'संपर्क करें' },
  ...
  zh: {
    translation: {
      ...
      hero: { title: '用富有同情心的关怀赋能生命', subtitle: '悉尼的专业 NDIS 支持服务...', getStarted: '开始', contactUs: '联系我们' },
  ...
  fr: {
    translation: {
      ...
      hero: { title: 'Autonomiser les Vies par des Soins Compatissants', subtitle: 'Services de soutien NDIS dédiés à Sydney...', getStarted: 'Commencer', contactUs: 'Nous Contacter' },
  ...
  es: {
    translation: {
      ...
      hero: { title: 'Empoderando Vidas a través de Cuidados Compasivos', subtitle: 'Servicios dedicados de apoyo NDIS en Sídney...', getStarted: 'Comenzar', contactUs: 'Contáctanos' },
  ...
  ar: {
    translation: {
      ...
      hero: { title: 'تمكين الحياة من خلال الرعاية الرحيمة', subtitle: 'خدمات دعم NDIS المخصصة في سيدني...', getStarted: 'البدء', contactUs: 'اتصل بنا' },
